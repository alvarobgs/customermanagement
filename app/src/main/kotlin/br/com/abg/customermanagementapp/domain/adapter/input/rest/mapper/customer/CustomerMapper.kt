package br.com.abg.customermanagementapp.domain.adapter.input.rest.mapper.customer
...
fun Customer.mapToFindCustomerByDocumentResponse() = FindCustomerByDocumentResponse(
    ...
    address = br.com.abg.customermanagementapp.domain.adapter.input.rest.controller.customer.model.response.FindCustomerByDocumentResponse.Address(
...
fun Customer.mapToCustomerKafkaPayload() : CustomerKafkaPayload {
    ...
    payload.name = name
    payload.bornDate = DateTimeFormatter.ofPattern(br.com.abg.customermanagementapp.core.common.API_DATE_PATTERN).format(bornDate)
    payload.phone = phone
